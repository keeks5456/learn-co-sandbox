...
# or use .each_pair helper_method
# bands.each_pair{|pair| p pair} # its literally the same
...
# if we wanted to sort alphebetically
...
# if we wanted to accumulate to a single value 

first_name = bands.reduce(nil) do |memo, (key,value)|
